...
(function(w) {
    function u(a, b) {
        var c = Math.abs(a),
            e = Math.abs(b);
        return 0 === a ? Math.log(e) : 0 === b ? Math.log(c) : 3E3 > c && 3E3 > e ? .5 * Math.log(a * a + b * b) : Math.log(a / Math.cos(Math.atan2(b, a)))
    }
    ...
    h.prototype = {
        ...
        exp: function() {
            var a = this.x,
                ...
                d = Math.exp(this.w),
                f = d / e * Math.sin(e);
            return 0 === e ? new h(d, 0, 0, 0) : new h(d * Math.cos(e), a * f,
                b * f, c * f)
        },
        log: function() {
            var a = this.w,
            ...
            d = Math.atan2(d, a) / d;
            return new h(.5 * Math.log(b * b + c * c + e * e + a * a), b * d, c * d, e * d)
        },
        pow: function(a, b, c, e) {
            ...
            if (0 === k.y && 0 === k.z) {
                ...
                if (0 === this.y && 0 === this.z) {
                    ...
                    e = u(a, b);
                    if (0 === k.x) {
                        if (0 === b && 0 <= a) return new h(Math.pow(a,
                            k.w), 0, 0, 0);
                        if (0 === a) switch (k.w % 4) {
                            case 0:
    ...
    h.fromEuler = function(a, b, c, e) {
        ...
        f = Math.sin(f);
        g = Math.sin(g);
        return void 0 === e || "ZXY" === e ? new h(a * c * b - d * f * g, d * c * b - a * f * g, a * f * b + d * c * g, a * c * g + d * f * b) : "XYZ" === e ? new h(a * c * b - d * f * g, d * c * b + a * f * g, a * f * b - d * c * g, a * c * g + d * f * b) : "YXZ" === e ? new h(a * c * b + d * f * g, d * c * b + a * f * g, a * f * b - d * c * g, a * c * g - d * f * b) : "ZYX" ===
            e ? new h(a * c * b + d * f * g, d * c * b - a * f * g, a * f * b + d * c * g, a * c * g - d * f * b) : "YZX" === e ? new h(a * c * b - d * f * g, d * c * b + a * f * g, a * f * b + d * c * g, a * c * g - d * f * b) : "XZY" === e ? new h(a * c * b + d * f * g, d * c * b - a * f * g, a * f * b - d * c * g, a * c * g + d * f * b) : null
    };
    "function" === typeof define && define.amd ? define([], function() {
        return h
    }) : "object" === typeof exports ? (Object.defineProperty(exports, "__esModule", {
        value: !0
    }), h["default"] = h, h.Quaternion = h, module.exports = h) : w.Quaternion = h
})(this);